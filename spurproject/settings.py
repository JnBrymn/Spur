# Django settings for spurproject project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'spurdb.db',                      # Or path to database file if using sqlite3.
        'USER': 'spurdev',                      # Not used with sqlite3.
        'PASSWORD': 'spurword',                  # Not used with sqlite3.
...
SECRET_KEY = '@=r(mfskv%b)a8n03ylgpcti#5!2p*=m2j04w^x$evlj+$@$eb'
...
ROOT_URLCONF = 'spurproject.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'spurproject.wsgi.application'
